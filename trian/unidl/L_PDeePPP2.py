...
for esm_ratio in esm_array:
    ...
    train_dataset = CustomDataset(
        f'/data/liuyuhuan/zhaijx/data/unidl/{ptm_type}/{esm_ratio}/train_combined_representations',
        f'/data/liuyuhuan/zhaijx/data/unidl/{ptm_type}/{esm_ratio}/train_labels'
    )

    test_dataset = CustomDataset(
        f'/data/liuyuhuan/zhaijx/data/unidl/{ptm_type}/{esm_ratio}/test_combined_representations',
        f'/data/liuyuhuan/zhaijx/data/unidl/{ptm_type}/{esm_ratio}/test_labels'
    )
    ...
    # 保存结果的路径
    save_dir = f'/data/liuyuhuan/zhaijx/model/unidl/{ptm_type}'
