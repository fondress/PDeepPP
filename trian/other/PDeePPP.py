...
for esm_ratio in esm_array:
    ...
    train_representations = np.load(f'/data/liuyuhuan/zhaijx/data/{ptm_name}/{esm_ratio}/train_combined_representations.npy')
    train_labels = np.load(f'/data/liuyuhuan/zhaijx/data/{ptm_name}/{esm_ratio}/train_labels.npy')
    test_representations = np.load(f'/data/liuyuhuan/zhaijx/data/{ptm_name}/{esm_ratio}/test_combined_representations.npy')
    test_labels = np.load(f'/data/liuyuhuan/zhaijx/data/{ptm_name}/{esm_ratio}/test_labels.npy')
    # 转换为张量
    ...
    transformer = TransConv1d(input_size, output_size).to(device)
    cnn = PosCNN(input_size, output_size).to(device)
