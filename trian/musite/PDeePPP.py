...
for esm_ratio in esm_array:
    train_representations = np.load(f'/data/liuyuhuan/zhaijx/weight/musite/{ptm_name}/{esm_ratio}/train_combined_representations.npy')
    train_labels = np.load(f'/data/liuyuhuan/zhaijx/weight/musite/{ptm_name}/{esm_ratio}/train_labels.npy')
    test_representations = np.load(f'/data/liuyuhuan/zhaijx/weight/musite/{ptm_name}/{esm_ratio}/test_combined_representations.npy')
    test_labels = np.load(f'/data/liuyuhuan/zhaijx/weight/musite/{ptm_name}/{esm_ratio}/test_labels.npy')
    ...
    # 模型保存目录
    save_dir = f'/data/liuyuhuan/zhaijx/essay_model/{ptm_name}'
    if not os.path.exists(save_dir):
        os.makedirs(save_dir)

    # 输出预测结果文件的目录
    results_dir = f'/data/liuyuhuan/zhaijx/results/{ptm_name}'
